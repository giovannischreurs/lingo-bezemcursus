...
class RoundTest {
    ...
    @Test
    @DisplayName("Hints based on former guesses")
    void generateHintBasedOnHintHistory() {
        round.guess("BAKEN");
    ...
    @Test
    @DisplayName("Feedback history")
    void feedbackHistory() {
        round.guess("DAKEN");
        round.guess("DAKEN");
    ...
    @Test
    @DisplayName("If there is no feedback throw an exception")
...
//    }
    ...
    @ParameterizedTest
    @MethodSource("provideDifferentLengthWordExamples")
    ...
    static Stream<Arguments> provideDifferentLengthWordExamples() {
